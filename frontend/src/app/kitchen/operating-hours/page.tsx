...
import { Clock, Calendar, Plus, Trash2, Save, RefreshCw } from 'lucide-react';
...
export default function KitchenOperatingHoursPage() {
          ...
          {isLoading ? (
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="space-y-6">
                ...
                <Card className="p-5">
                  <h2 className="mb-4 text-sm font-bold uppercase tracking-wider text-zinc-500">Configured Date Overrides</h2>
