...
export const AUDIT_ACTIONS = {
  ...
  KITCHEN_DELETED: 'KITCHEN_DELETED',
  ...
  ROOM_BOOKING_PAYMENT_RECORDED: 'ROOM_BOOKING_PAYMENT_RECORDED',
  ROOM_TRANSFER_REQUESTED: 'ROOM_TRANSFER_REQUESTED',
  ROOM_TRANSFER_COMPLETED: 'ROOM_TRANSFER_COMPLETED',
  ROOM_TRANSFER_CANCELLED: 'ROOM_TRANSFER_CANCELLED',
  ROOM_CATEGORY_MIGRATED: 'ROOM_CATEGORY_MIGRATED',
  ...
  PARK_SLOT_CREATED: 'PARK_SLOT_CREATED',
  PARK_SLOT_DELETED: 'PARK_SLOT_DELETED',
