...
const vehicleSchema = new Schema<IVehicle>(
  {
    ...
    parkingSlot: { type: String, trim: true, index: true },
    fuelLevel: { type: String, trim: true },
    odometer: { type: Number },
    keyTag: { type: String, trim: true },
    status: {
      type: String,
    ...
    photos: {
      front: { type: vehiclePhotoSchema },
      rear: { type: vehiclePhotoSchema },
      left: { type: vehiclePhotoSchema },
      right: { type: vehiclePhotoSchema },
      dashboard: { type: vehiclePhotoSchema },
